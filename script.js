// Function to get the base64-encoded SVG content
function getBase64EncodedSVG() {
	// Get the SVG element inside the box
	const svgElement = document.querySelector("#zoomFilter");
	// Convert the SVG DOM element to an XML string
